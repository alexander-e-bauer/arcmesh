...
describe('palette codec', () => {
  ...
  it.each([
    ...
    ['crease radius out of range', btoa('2|1|0.16,0.02,10|10,0.1,0.5,0.5,0.5,0;20,0.1,0.5,0.5,0.5,0;30,0.1,0.5,0.5,0.5,0;40,0.1,0.5,0.5,0.5,0|0,1.3,0.2,2.6,0.4,0.6')],
    ['crease center out of range', btoa('2|1|0.16,0.02,10|10,0.1,0.5,0.5,0.5,0;20,0.1,0.5,0.5,0.5,0;30,0.1,0.5,0.5,0.5,0;40,0.1,0.5,0.5,0.5,0|0,4.5,0.2,0.9,0.4,0.6')],
    ['crease center below range', btoa('2|1|0.16,0.02,10|10,0.1,0.5,0.5,0.5,0;20,0.1,0.5,0.5,0.5,0;30,0.1,0.5,0.5,0.5,0;40,0.1,0.5,0.5,0.5,0|0,1.3,-3.5,0.9,0.4,0.6')],
  ...
  it('accepts a crease dragged a full canvas past where generation puts it', () => {
    const dragged = btoa('2|1|0.16,0.02,10|10,0.1,0.5,0.5,0.5,0;20,0.1,0.5,0.5,0.5,0;30,0.1,0.5,0.5,0.5,0;40,0.1,0.5,0.5,0.5,0|0,3.9,-2.9,0.9,0.4,0.6');
    expect(decodePalette(dragged)?.creases).toEqual([{ stop: 0, cx: 3.9, cy: -2.9, r: 0.9, t0: 0.4, t1: 0.6 }]);
  });
